...
const UserForm = ({ editMode = false, userData = null }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response) {
                alert(editMode ? 'Người dùng đã được cập nhật!' : 'Người dùng đã được tạo thành công!');
                navigate(adminRouteConfig.listUsers);
            } else {
                    ...
                    <div className={cx('form-row')}>
                        <div className={cx('form-group')}>
                            ...
                            {validationErrors.username && (
                                <div className={cx('error-message')}>{validationErrors.username}</div>
                            )}
                        </div>
                        <div className={cx('form-group')}>
                            ...
                            {validationErrors.email && (
                                <div className={cx('error-message')}>{validationErrors.email}</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className={cx('form-row')}>
                        <div className={cx('form-group')}>
                            ...
                            {validationErrors.password && (
                                <div className={cx('error-message')}>{validationErrors.password}</div>
                            )}
                        </div>
                        <div className={cx('form-group')}>
                            <label className={cx('form-label')}>
                            ...
                            {validationErrors.confirmPassword && (
                                <div className={cx('error-message')}>{validationErrors.confirmPassword}</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className={cx('form-row')}>
                        ...
                        <div className={cx('form-group')}>
                            ...
                            <input
                                ...
                                required
                            />
                            {validationErrors.dob && <div className={cx('error-message')}>{validationErrors.dob}</div>}
                        </div>
                    </div>
