...
function Footer() {
    ...
    return (
        <footer
            className={
                match?.pattern?.path === routes.movieDetail || matchWatchPage?.pattern?.path === routes.watch
            ...
            <div className={cx('footer-bottom')}>
                <div className={cx('footer-info')}>
                    <p>
                        ...
                        <br />
                        Nhờ hệ thống lưu trữ thông minh, phim luôn có chất lượng Full HD, 4K, phát nhanh, không giật
                        lag.
                        <br />
