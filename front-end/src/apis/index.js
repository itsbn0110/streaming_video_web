...
export const fetchAllMoviesAPI = async (page = 0, size = 5) => {
    const res = await axios.get(`${API_BASE_URL}/movies/get-all?page=${page}&size=${size}`);
    return res.data;
};

export const createMovieDataAPI = async (formData) => {
    const res = await axios.post(`${API_BASE_URL}/v1/google-drive/upload`, formData, {
        headers: {
...
export const updateMovieDataAPI = async (movieId, formData) => {
    const res = await axios.put(`${API_BASE_URL}/movies/update/${movieId}`, formData, {
        headers: {
            'Content-Type': 'multipart/form-data',
            ...getAuthHeaders(),
        },
...
export const deleteMovieDataAPI = async (movieId) => {
    const res = await axios.delete(`${API_BASE_URL}/movies/delete/${movieId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const fetchNewlyUpdatedMoviesAPI = async (categorySlug) => {
    const res = await axios.get(`${API_BASE_URL}/movies/newly-updated/${categorySlug}`);
    return res.data;
};
...
export const fetchGenreDataAPI = async (genreId) => {
    const res = await axios.get(`${API_BASE_URL}/genres/${genreId}`, { headers: getAuthHeaders() });
    return res.data;
};

export const createGenreDataAPI = async (payload) => {
    const res = await axios.post(`${API_BASE_URL}/genres`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const updateGenreDataAPI = async (genreId, payload) => {
    const res = await axios.put(`${API_BASE_URL}/genres/${genreId}`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const deleteGenreDataAPI = async (genreId) => {
    const res = await axios.delete(`${API_BASE_URL}/genres/${genreId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const fetchCategoryDataAPI = async (categoryId) => {
    const res = await axios.get(`${API_BASE_URL}/categories/${categoryId}`, { headers: getAuthHeaders() });
    return res.data;
};

export const createCategoryDataAPI = async (payload) => {
    const res = await axios.post(`${API_BASE_URL}/categories`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const updateCategoryDataAPI = async (categoryId, payload) => {
    const res = await axios.put(`${API_BASE_URL}/categories/${categoryId}`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const deleteCategoryDataAPI = async (categoryId) => {
    const res = await axios.delete(`${API_BASE_URL}/categories/${categoryId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const deletePersonDataAPI = async (personId) => {
    const res = await axios.delete(`${API_BASE_URL}/person/${personId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const createCountryDataAPI = async (payload) => {
    const res = await axios.post(`${API_BASE_URL}/countries`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const updateCountryDataAPI = async (countryId, payload) => {
    const res = await axios.put(`${API_BASE_URL}/countries/${countryId}`, payload, { headers: getAuthHeaders() });
    return res.data;
};

export const deleteCountryDataAPI = async (countryId) => {
    const res = await axios.delete(`${API_BASE_URL}/countries/${countryId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const fetchUserDataAPI = async (userId) => {
    const res = await axios.get(`${API_BASE_URL}/users/${userId}`, { headers: getAuthHeaders() });
    return res.data;
};
...
export const deleteUserDataAPI = async (userId) => {
    const res = await axios.delete(`${API_BASE_URL}/users/delete/${userId}`, { headers: getAuthHeaders() });
    return res.data;
};
